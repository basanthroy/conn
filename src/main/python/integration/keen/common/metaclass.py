...
metaclass_info = {"tracker_event"           : {klass : TrackerEventTSTransformer(),
                  ...
                  "bid_overlap_cities"      : {klass : BidOverlapTransformer(),
                                               ...
                                               keen_collection_name_function : (lambda coll, data_sink_logger_tuple :
                                                        coll),
                                               entity_base_dir_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/radiumone/connect/overlap/top_cities/dt={}/",
                                               entity_filepath_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/radiumone/connect/overlap/top_cities/dt={}/{}",
                  ...
                  "bid_overlap_categories"  : {klass: BidOverlapTransformer(),
                                               ...
                                               keen_collection_name_function: (lambda coll, data_sink_logger_tuple:
                                                       coll),
                                               entity_base_dir_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/radiumone/connect/overlap/top_content_categories/dt={}/",
                                               entity_filepath_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/radiumone/connect/overlap/top_content_categories/dt={}/{}",
                                               file_list_retriever : FileListRetrieverBidOverlap
                                               },
                  "bid_overlap_domains"     : {klass: BidOverlapTransformer(),
                                               ...
                                               keen_collection_name_function: (lambda coll, data_sink_logger_tuple:
                                                       coll),
                                               entity_base_dir_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/radiumone/connect/overlap/top_domains/dt={}/",
                                               entity_filepath_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/radiumone/connect/overlap/top_domains/dt={}/{}",
                                               file_list_retriever : FileListRetrieverBidOverlap
                                               },
                  "bid_overlap_media_types" : {klass: BidOverlapTransformer(),
                                               ...
                                               keen_collection_name_function: (lambda coll, data_sink_logger_tuple:
                                                       coll),
                                               entity_base_dir_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/radiumone/connect/overlap/top_media_types/dt={}/",
                                               entity_filepath_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/radiumone/connect/overlap/top_media_types/dt={}/{}",
                                               file_list_retriever : FileListRetrieverBidOverlap
                                               },
                  "kochava_performance"     : {klass: KochavaPerformanceTransformer(),
                                               ...
                                               keen_collection_name_function: (lambda coll, data_sink_logger_tuple:
                                                       coll),
                                               entity_base_dir_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/partner/kochava/app_campaign2/dt={}/hr={}/",
                                               entity_filepath_template : "hdfs://namenode1.dw.sc.gwallet.com:8020/data/partner/kochava/app_campaign2/dt={}/hr={}/{}",
                                               file_list_retriever : FileListRetrieverTrackerEventJson
                                               }
                  }
